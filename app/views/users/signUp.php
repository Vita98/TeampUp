    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <p>Compila questo form per registrarti alla nostra piattaforma</p>
                <form action="<?php echo URLROOT; ?>/users/signUp" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-light btn-block">Hai un account?? Login</a>
                        </div>
                    </div>
                </form>
            </div>
